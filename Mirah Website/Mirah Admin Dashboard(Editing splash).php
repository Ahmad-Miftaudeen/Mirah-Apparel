<!DOCTYPE html>
    <html>
        <head>
            ...
            <title>Mirah Admin Dashboard</title>
            <script>
...
@media only screen and (max-width:340px){
    ...
    .container{
        ...
        <body>
            ...
            <h1 id="adminpostheading">Edit Splash</h1>
            <ul>
            ...
            <div class="container">
  <form action="Mirah EditingsplashDB.php" method="POST">
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="title" name="title" placeholder="Type the title of the splash here..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="Imagelink" name="Imagelink" placeholder="Paste the image link here..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="splashparagraph">Splash Paragraph</label>
      </div>
      <div class="col-75">
        <textarea id="splashparagraph" name="splashparagraph" placeholder="About the splash.." style="height:200px"></textarea>
      </div>
    </div>
    <div class="row">
